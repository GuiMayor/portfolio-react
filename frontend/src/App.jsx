...
// Estado del chat y API key vacía ya que usamos FastAPI local
const apiKey = ""; // La plataforma proporciona la clave automáticamente (FastAPI la reemplaza)
...
const App = () => {
  ...
  const callGemini = async (prompt, systemPrompt) => {
    // Ahora se usa FastAPI local, por eso url apunta al backend
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-[#0A192F]">
          ...
          <div className="hidden md:flex justify-end">
            ...
            <div className="w-80 bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-200 flex flex-col h-[400px]">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50">
                ...
                {isTyping && <div className="text-[10px] text-slate-400 italic">FastAPI está redactando...</div>}
                <div ref={chatEndRef} />
              </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 text-emerald-400 font-bold text-[10px] uppercase mb-4 tracking-widest">
              <Sparkles size={16} /> FastAPI Core Engine
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-2xl text-navy">
            ...
            >
              {isAnalyzing ? <><Loader2 className="animate-spin" /> Analizando con FastAPI...</> : <>✨ Comprobar Compatibilidad Laboral</>}
            </button>
            ...
            {aiAnalysis && (
              <div className="mt-8 p-6 bg-slate-50 rounded-2xl border border-emerald-100 animate-in fade-in slide-in-from-bottom-2">
                <div className="flex items-center gap-6 mb-4">
                  ...
                  <div>
                    <h4 className="font-bold text-emerald-600 uppercase text-xs tracking-widest">Análisis de FastAPI</h4>
      ...
      <footer className="py-12 bg-white text-center text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em]">
        © 2026 Strategic Branding & FastAPI Intelligence
      </footer>
    </div>
  );
};
